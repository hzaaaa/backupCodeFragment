  ...
  <div>
    ...
    <el-dialog v-model="dialogVisible" :title="dialogTitle" width="1000px">
      <el-form :model="editFormShow" label-width="120px">
        <el-row>
          <el-col :span="12">
            <el-form-item label="服务ID:" align>
              <el-input v-model="editFormShow.serviceId" placeholder="服务ID" clearable></el-input>
            </el-form-item>
          </el-col>

          <el-col :span="12">
            <el-form-item label="服务地址:">
              <el-input v-model="editFormShow.serviceAddress" placeholder="服务地址" clearable></el-input>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <!-- <el-col :span="12">
                        <el-form-item label="描述:">
                            ...
                            <el-select v-model="editFormShow.description" clearable placeholder="请选择" style="width: 100%;">
        ...
        <el-row>
          <el-col :span="24">
            <el-form-item label="描述:">
              <el-input type="textarea" :rows="5" v-model="editFormShow.description" placeholder="描述" clearable></el-input>
            </el-form-item>
          </el-col>
        </el-row>
      </el-form>
